...
#define PDL_LPC_MIDDLE_SPEED_MODE_1			0x00000020ul
#define PDL_LPC_MIDDLE_SPEED_MODE_2			0x00000040ul
#define PDL_LPC_LOW_SPEED_MODE_1			0x00000080ul
#define PDL_LPC_LOW_SPEED_MODE_2			0x00000100ul
...
#define PDL_LPC_POWER_TO_ROM_DISABLE		0x00001000ul
#define PDL_LPC_POWER_TO_ROM_ENABLE			0x00002000ul
#define PDL_LPC_POWER_TO_HOCO_DISABLE		0x00004000ul
#define PDL_LPC_POWER_TO_HOCO_ENABLE		0x00008000ul
#define PDL_LPC_POWER_TO_LVD				0x00010000ul
#define PDL_LPC_POWER_TO_POR				0x00020000ul

/*Deep software standby */
#define PDL_LPC_DEEPCUT_DISABLE				0x00040000ul
#define PDL_LPC_DEEPCUT_ENABLE				0x00080000ul
...
#define PDL_LPC_CHANGE_MIDDLE_SPEED_1		0x00000400ul
#define PDL_LPC_CHANGE_MIDDLE_SPEED_2		0x00000800ul
#define PDL_LPC_CHANGE_LOW_SPEED_1			0x00001000ul
#define PDL_LPC_CHANGE_LOW_SPEED_2			0x00002000ul

/* Sleep mode return clock source switching */
#define PDL_LPC_SLEEP_RETURN_CHANGE_DISABLE	0x00004000ul
#define PDL_LPC_SLEEP_RETURN_CHANGE_HOCO	0x00008000ul
#define PDL_LPC_SLEEP_RETURN_CHANGE_MAIN	0x00010000ul
