/*""FILE COMMENT""*******************************************************
* System Name	: I/O Port API for RX210 (100-pin package)
* File Name		: r_pdl_io_port_RX210_100_pin.h
* Version		: 0.20
...
#ifndef R_PDL_IO_PORT_RX210_100_PIN_H
#define R_PDL_IO_PORT_RX210_100_PIN_H
...
( \
( ((a) >= PDL_IO_PORT_0_3) && ((a) <= (PDL_IO_PORT_J_3 | PDL_IO_PORT_J_1)) ) ? \
...
( ((a) >= PDL_IO_PORT_0) && ((a) <= PDL_IO_PORT_J) ) ? \
...
( \
( (((a) >= PDL_IO_PORT_0_3) && ((a) <= (PDL_IO_PORT_J_3 | PDL_IO_PORT_J_1))) && (b == 1u) ) ? \
R_IO_PORT_WaitAll( (uint8_t)((a) >> 8), (uint8_t)(a), (uint8_t)(a) ) : \
( (((a) >= PDL_IO_PORT_0_3) && ((a) <= (PDL_IO_PORT_J_3 | PDL_IO_PORT_J_1))) && (b == 0u) ) ? \
