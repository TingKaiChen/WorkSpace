...
/* Pin selection */
#define PDL_IIC_PIN_SDA					0x01u
#define PDL_IIC_PIN_SDA_DS				0x02u
#define PDL_IIC_PIN_SCL					0x04u
#define PDL_IIC_PIN_SCL_DS				0x08u

/* Bus mode */
#define PDL_IIC_MODE_IIC				0x00000001ul										
#define PDL_IIC_MODE_SMBUS				0x00000002ul										

/* Internal reference clock */
#define PDL_IIC_INT_PCLK_DIV_1			0x00000004ul
#define PDL_IIC_INT_PCLK_DIV_2			0x00000008ul
#define PDL_IIC_INT_PCLK_DIV_4			0x00000010ul
#define PDL_IIC_INT_PCLK_DIV_8			0x00000020ul
#define PDL_IIC_INT_PCLK_DIV_16			0x00000040ul
#define PDL_IIC_INT_PCLK_DIV_32			0x00000080ul
#define PDL_IIC_INT_PCLK_DIV_64			0x00000100ul
#define PDL_IIC_INT_PCLK_DIV_128		0x00000200ul

/* Timeout detection */
#define PDL_IIC_TIMEOUT_DISABLE			0x00000400ul
#define PDL_IIC_TIMEOUT_LOW				0x00000800ul
#define PDL_IIC_TIMEOUT_HIGH			0x00001000ul
#define PDL_IIC_TIMEOUT_BOTH			0x00002000ul

/* Timeout mode */
#define PDL_IIC_TIMEOUT_LONG			0x00004000ul
#define PDL_IIC_TIMEOUT_SHORT			0x00008000ul

/* SDA output delay count */
#define PDL_IIC_SDA_DELAY_0				0x00010000ul
#define PDL_IIC_SDA_DELAY_1				0x00020000ul
#define PDL_IIC_SDA_DELAY_2				0x00040000ul
#define PDL_IIC_SDA_DELAY_3				0x00080000ul
#define PDL_IIC_SDA_DELAY_4				0x00100000ul
#define PDL_IIC_SDA_DELAY_5				0x00200000ul
#define PDL_IIC_SDA_DELAY_6				0x00400000ul
#define PDL_IIC_SDA_DELAY_7				0x00800000ul

/* SDA output delay clock source */
#define PDL_IIC_SDA_DELAY_DIV_1			0x01000000ul
#define PDL_IIC_SDA_DELAY_DIV_2			0x02000000ul

/* Noise filter control */
#define PDL_IIC_NF_DISABLE				0x04000000ul
#define PDL_IIC_NF_1					0x08000000ul
#define PDL_IIC_NF_2					0x10000000ul
#define PDL_IIC_NF_3					0x20000000ul
#define PDL_IIC_NF_4					0x40000000ul
