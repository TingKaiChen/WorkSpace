...
#ifndef R_PDL_TMR_RX210xx_H
#define R_PDL_TMR_RX210xx_H
...
ReturnFalse() : \
( (a) <= PDL_TMR_TMR3 ) ? \
R_TMR_ControlPeriodicChannelAll( (a), (b), (double)(c), (double)(d) ) : \
R_TMR_ControlPeriodicUnitAll( (a - PDL_TMR_UNIT0), (b), (double)(c), (double)(d) ) \
)
