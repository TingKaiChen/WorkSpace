...
#define RS_PIN PDL_IO_PORT_J_1
/* Display enable pin */	
#define E_PIN  PDL_IO_PORT_J_3
...
void Display_LCD(uint8_t, const uint8_t *);
/* LCD write function declaration */
void LCD_write(uint8_t, uint8_t);
/* Clear LCD function declaration */
void Clear_LCD(void);
